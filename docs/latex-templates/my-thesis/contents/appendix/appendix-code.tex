...
Keempat \textit{smart contract} Lakomi diimplementasikan menggunakan Solidity 0.8.20 dan diterapkan pada jaringan DChain (Chain ID 17845). Kode sumber lengkap tersedia pada repositori GitHub \url{https://github.com/iZcy/Lakomi}. Tabel \ref{tab:contract-list} merangkum informasi setiap kontrak.
...
\scriptsize
\resizebox{\textwidth}{!}{\begin{tabular}{p{0.04\textwidth}p{0.12\textwidth}p{0.33\textwidth}p{0.16\textwidth}p{0.25\textwidth}}
\toprule
...
3 & 24(3) & Verifikasi satu suara per anggota (dua anggota beda token) & Token & \texttt{getVotingPower()} \\
4 & 17--18 & Pencetakan 100 LAK pada pendaftaran & Token & \texttt{registerMember()} \\
5 & 19(3) & Penolakan transfer token antar akun & Token & \texttt{transfer()} \\
6 & 19--21 & Pengunduran diri sukarela tanpa pinjaman aktif & Token & \texttt{resignMembership()} \\
7 & 24(3) & Penolakan voting oleh non-anggota & Govern & \texttt{castVote()} \\
8 & 41(2)(a) & Pembayaran simpanan pokok satu kali & Vault & \texttt{paySimpananPokok()} \\
9 & 41(2)(a) & Penolakan pembayaran simpanan pokok ganda & Vault & \texttt{paySimpananPokok()} \\
10 & 24(2) & Verifikasi kuorum, proposal lolos dengan 3 dari 3 suara & Govern & \texttt{castVote()} \\
11 & 24(2) & Proposal gagal karena di bawah kuorum & Govern & \texttt{castVote()} \\
...
15 & 19(2), 30(2)(b) & Pencabutan keanggotaan melalui proposal tata kelola & Token+Govern & \texttt{revokeMembership()} \\
...
19 & 41(2)(b) & Pembayaran simpanan wajib periodik & Vault & \texttt{paySimpananWajib()} \\
20 & Permenkop 8/2023 & Penyetoran simpanan sukarela & Vault & \texttt{deposit()} \\
21 & 41(2)(c), 45(2-3) & Akumulasi dana cadangan dari pendapatan & Vault & \texttt{distributeSHU()} \\
...
25 & 41(2)(a), 44 & Pengajuan pinjaman dengan LTV berbasis kontribusi & Loans & \texttt{requestLoan()} \\
26 & 41(2)(a), 44 & Pelunasan pinjaman dan pelepasan agunan & Loans & \texttt{repayInFull()} \\
\bottomrule
\end{tabular}}
\end{table}
