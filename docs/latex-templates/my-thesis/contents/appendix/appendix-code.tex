...
\node[layer, fill=blue!8, minimum width=8cm] (domain) at (0,0.1) {\textbf{Domain Layer} --- UU 25/1992 Compliance Rules (26 Pasal)};
\node[layer, fill=orange!10, minimum width=10.5cm] (infra) at (0,-1.6) {\textbf{Infrastructure Layer} --- DChain (EVM-Compatible, Chain ID 17845)};
...
\draw[->, >=stealth, dashed, red!40] (app.west) to[out=180, in=180] (infra.west) node[midway, left, font=\footnotesize] {gas cost};
\end{tikzpicture}
