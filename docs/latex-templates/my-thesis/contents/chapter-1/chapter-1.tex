...
\begin{enumerate}
	\item \textbf{Lingkungan Deployment.} Sistem di-deploy dan diuji pada lingkungan pengujian DChain, bukan pada \textit{mainnet} produksi DChain. Meskipun jaringan pengujian menggunakan arsitektur dan \textit{chain ID} yang identik, volume transaksi dan jumlah partisipan pada lingkungan produksi akan jauh lebih besar---sehingga hasil pengujian kinerja dan biaya gas pada lingkungan pengujian tidak dapat diekstrapolasi secara langsung ke lingkungan produksi tanpa validasi lebih lanjut.
