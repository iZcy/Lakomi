...
\draw[arr] (active) -- (succ) node[midway, left, font=\footnotesize] {quorum+maj};
\draw[arr] (active) -- (def) node[midway, right, font=\footnotesize] {no quorum};
\draw[arr] (active) -- (expired) node[midway, right, font=\footnotesize] {timeout};
...
\draw[arr] (queue) -- (veto) node[midway, left, font=\footnotesize] {veto};
