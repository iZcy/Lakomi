...
\begin{enumerate}
	\item \textbf{Pendaftaran dan Keanggotaan (Pasal 5(1), 17--18, 19--21, 31)} --- Skenario pengujian meliputi: pendaftaran anggota mandiri dengan pembayaran simpanan pokok 100 IDRX dan penerimaan 100 token LAK; verifikasi bahwa \texttt{isRegisteredMember} bernilai \texttt{true} setelah pendaftaran; penolakan pendaftaran ganda; pengunduran diri sukarela melalui \texttt{resignMembership()}; dan pencabutan keanggotaan melalui proposal tata kelola menggunakan \texttt{revokeMembership()}.
