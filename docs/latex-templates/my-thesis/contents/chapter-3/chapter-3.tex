...
\begin{enumerate}
	...
	\end{itemize}
	\item \textbf{\textit{Blockchain Layer}}, Seluruh kontrak diterapkan pada DChain (EVM-compatible~\cite{wood2014ethereum}, Chain ID 17845), jaringan blockchain konsorsium pendidikan tinggi Indonesia.
\end{enumerate}
