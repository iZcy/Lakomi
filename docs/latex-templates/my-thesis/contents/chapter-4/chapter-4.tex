...
Secara keseluruhan, biaya operasional sistem Lakomi pada DChain sangat rendah---seluruh operasi bulanan untuk koperasi dengan 100 anggota diperkirakan di bawah 0,01 DKT, menjadikannya layak secara ekonomi untuk operasional koperasi sehari-hari. Biaya ini jauh lebih rendah dibandingkan biaya administrasi manual konvensional yang diperkirakan mencapai Rp300.000--1.000.000 per bulan (gaji staf, dokumen fisik, audit eksternal).
