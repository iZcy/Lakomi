...
\section{Analisis Biaya Gas}

Analisis biaya gas dilakukan untuk mengukur konsumsi komputasi setiap operasi utama koperasi pada lingkungan DChain. Pengukuran dilakukan menggunakan \textit{gas reporter} Hardhat yang mencatat konsumsi gas untuk setiap fungsi \textit{smart contract}. Tabel~\ref{tab:gas-costs} menyajikan estimasi konsumsi gas untuk tujuh operasi utama.
