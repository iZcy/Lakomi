...
\begin{enumerate}
	\item \textbf{Deployment pada DChain Mainnet.} Sistem Lakomi saat ini di-deploy pada lingkungan pengujian. Deployment pada DChain \textit{mainnet} diperlukan untuk memvalidasi kinerja dan keandalan sistem dalam lingkungan produksi dengan volume transaksi dan jumlah anggota yang lebih besar. Deployment \textit{mainnet} juga memungkinkan evaluasi biaya gas dalam kondisi jaringan yang sesungguhnya.
