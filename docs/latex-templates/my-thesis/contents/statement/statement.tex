...
\noindent Nama \> : Yitzhak Edmund Tio Manalu \\[\parskip]
\noindent NIM \> : 22/499769/TK/54763 \\[\parskip]
\noindent Tahun terdaftar \> : 2022 \\[\parskip]
\noindent Program \> : Sarjana \\[\parskip]
\noindent Program Studi \> : Teknologi Informasi \\[\parskip]
\noindent Fakultas \> : Teknik \mbox{Universitas Gadjah Mada}
\end{tabbing}
...
\begin{flushright}
	\begin{tabular}{r}
		Yogyakarta, 4-6-2026 \\
		\vspace{0.1cm} \\
		\includegraphics[width=3cm]{figures/signature.png} \\[0.3cm]
