...
\title{\textit{Blockchain-Based Cooperative System}: Studi Kasus Implementasi \textit{Decentralized Autonomous Organization} pada Jaringan DChain}
...
% Explicit hyphenation exceptions
\hyphenation{meng-im-ple-men-ta-si-kan meng-im-ple-men-ta-si-kan-nya}
% EYD hyphenation patterns
% Prevent words from being cut at line breaks
\hyphenpenalty=10000
